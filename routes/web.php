...
Route::group(['middleware' => LangMiddleware::class], function () {
    Route::group(['middleware' => TrackUtmMiddleware::class], function () {
        ...
        Route::post('/admin/setting/forex/default/language', [LangController::class, 'defaultLanguage'])->name('admin.setting.forex.language.default');
        ...
        Route::post('/admin/setting/language/create', [LangController::class, 'languageStore'])->name('admin.setting.language.create');
    });
});
