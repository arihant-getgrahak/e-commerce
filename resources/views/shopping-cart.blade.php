                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-3">
                                                ...
                                                <a href="{{route("product.specific", $c->products[0]->slug)}}"><img
                                                        src="{{$c->products[0]->thumbnail}}" alt="{{$c->name}}" class="img-fluid"></a>
                                            </div>
                                            <div class="col d-flex align-items-center justify-content-between">
                                                <div class="cart_single_caption pl-2">
                                                    <h4 class="product_title fs-md ft-medium mb-1 lh-1">{{$c->name}}</h4>
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-sm list-group-flush-y list-group-flush-x">
                                <li class="list-group-item d-flex text-dark fs-sm ft-regular">
                                    <span>Subtotal</span> <span class="ml-auto text-dark ft-medium">{{$cart[0]->currency_code}}{{$price}}</span>
                                </li>
                                <li class="list-group-item d-flex text-dark fs-sm ft-regular">
                                    <span>Tax</span> <span class="ml-auto text-dark ft-medium">{{$cart[0]->currency_code}}{{$tax_value}}</span>
                                </li>
                                <li class="list-group-item d-flex text-dark fs-sm ft-regular">
                                    <span>Total</span> <span class="ml-auto text-dark ft-medium">{{$cart[0]->currency_code}}{{$finalprice}}</span>
                                </li>
